...
\begin{parts}
    ...
    \begin{enumerate}[label=\roman*.]
        ...
        We have 
        \[
        h_i = \relu (x_j W_{ji} + b_i).
        \]
        It follows that 
        \[
        \pd{h_i}{x_j} = 1 \left\{ b_i + x_j W_{ji} > 0 \right\}
        W_{ji}.
        \]
        }
        ...
        Note that 
        \[
        J(\theta) = - \log \hat{\by}_c = 
        - \bl_c + \log \sum_j \exp (\bl_j).
        \]
        It follows that 
        \[
        \pd{J}{\bl_i} = - 1 \left\{ c = i \right\} + 
        \frac{\bl_i}{\sum_j \exp (\bl_j)} 
        = -1 \left\{ c = i \right\} + \hat{\by}_i.
        \]
        This implies that 
        \[
        \pd{J}{\bl} = \hat{\by} - \by.
