    ...
    \part[4] Adam Optimizer\newline
        ...
        \begin{subparts}
            ...
            \subpart[2]First, Adam uses a trick called {\it momentum} by keeping track of $\bm$, a rolling average of the gradients:
                ...
                \ifans{Using $\bm$ makes the update varying less since it uses a weighted mean of updates from different mini batches. This low variance helps with leanring since it make the algorithm converge faster.}
            ...
            \subpart[2] Adam extends the idea of {\it momentum} with the trick of {\it adaptive learning rates} by keeping track of  $\bv$, a rolling average of the magnitudes of the gradients:
                ...
                \ifans{
                The model without $\bv$ get larger updates. 
                Smaller updates is a desirable feature because 
                this shows that there is more uncertainty 
                about the true direction of the gradient, 
                indicating that the model is close to optimum.
                }
          ...
          \ifans{
          Dropout should be applied during training to reduce 
          overfitting, and it can be treated as a combination 
          of sparse networks. Dropout should not be applied 
          during evaluation because we want to combine all the 
          information from sparse networks, and use the full 
